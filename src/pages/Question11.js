...
function Question11({ navigation }) {
  ...
  function proxima() {
    ...
    setTimeout(() => {
      ...
      navigation.navigate('Question12', placar)
    }, 1000);
      ...
      <ScrollView> 
        <ImageBackground source={require('../../assets/pagina.png')} style={styles.backgroundImage} > 
          <View style={styles.container}>
            ...
            <Text style={styles.titulo}>No Scrum são auto-organizáveis e multifuncionais.
             </Text>
            ...
            <TouchableOpacity activeOpacity={0.6} onPress={vencedor}>
              <Text style={btn}> Time de Desenvolvimento </Text>
            </TouchableOpacity>
            <TouchableOpacity activeOpacity={0.6} onPress={perde2}>
              <Text style={bp2}> Papéis </Text>
            </TouchableOpacity>
