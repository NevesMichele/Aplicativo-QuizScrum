...
function Question2({ navigation }) {
  ...
  function proxima() {
    ...
    setTimeout(() => {
      ...
      navigation.navigate('Question3', placar)
    }, 1000);
      ...
      <ScrollView> 
        <ImageBackground source={require('../../assets/pagina.png')} style={styles.backgroundImage} > 
          <View style={styles.container}>
            ...
            <Text style={styles.titulo}>______ é responsável pelo gerenciamento do  Backlog do Produto.
             </Text>


            <TouchableOpacity activeOpacity={0.6} onPress={perde1}>
              <Text style={bp1}> Scrum Master </Text>
            </TouchableOpacity>
            ...
            <TouchableOpacity activeOpacity={0.6} onPress={vencedor}>
              <Text style={btn}> Product owner </Text>
            </TouchableOpacity>
            <Text>
