...
function Question4({ navigation }) {
  ...
  function proxima() {
    ...
    setTimeout(() => {
      ...
      navigation.navigate('Question5', placar)
    }, 1000);
      ...
      <ScrollView> 
        <ImageBackground source={require('../../assets/pagina.png')} style={styles.backgroundImage} > 
          <View style={styles.container}>
            ...
            <Text style={styles.titulo}>O coração do Scrum é a ______, que tem time-boxed de um mês ou menos.
             </Text>


            <TouchableOpacity activeOpacity={0.6} onPress={perde1}>
              <Text style={bp1}> Eventos Scrum </Text>
            </TouchableOpacity>
            <TouchableOpacity activeOpacity={0.6} onPress={vencedor}>
              <Text style={btn}> Sprint </Text>
            </TouchableOpacity>
            <TouchableOpacity activeOpacity={0.6} onPress={perde2}>
              <Text style={bp2}> Backlog do produto </Text>
            </TouchableOpacity>
