...
function Question8({ navigation }) {
  ...
  function proxima() {
    ...
    setTimeout(() => {
      ...
      navigation.navigate('Question9', placar)
    }, 1000);
      ...
      <ScrollView> 
        <ImageBackground source={require('../../assets/pagina.png')} style={styles.backgroundImage} > 
          <View style={styles.container}>
            ...
            <Text style={styles.titulo}>No Scrum tem um evento time-boxed de 15 minutos.
             </Text>

            <TouchableOpacity activeOpacity={0.6} onPress={vencedor}>
              <Text style={btn}> Reunião diaria </Text>
            </TouchableOpacity>
            <TouchableOpacity activeOpacity={0.6} onPress={perde1}>
              <Text style={bp1}> Planejamento da sprint </Text>
            </TouchableOpacity>
            <TouchableOpacity activeOpacity={0.6} onPress={perde2}>
              <Text style={bp2}> Sprint </Text>
            </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  // aqui também não precisou mexer no padding
