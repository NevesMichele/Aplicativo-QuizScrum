...
function Question6({ navigation }) {
  ...
  function proxima() {
    ...
    setTimeout(() => {
      ...
      navigation.navigate('Question7', placar)
    }, 1000);
      ...
      <ScrollView> 
        <ImageBackground source={require('../../assets/pagina.png')} style={styles.backgroundImage} > 
          <View style={styles.container}>
            ...
            <Text style={styles.titulo}>Faz o uso de cartões para sinalizar o andamento do projeto.
           </Text>
            ...
            <TouchableOpacity activeOpacity={0.6} onPress={perde2}>
              <Text style={bp2}> Scrum master </Text>
            </TouchableOpacity>
            <TouchableOpacity activeOpacity={0.6} onPress={vencedor}>
              <Text style={btn}> Kanban </Text>
            </TouchableOpacity>
            <Text>
