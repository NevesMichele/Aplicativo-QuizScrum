...
function Question1({ navigation }) {
  ...
  function proxima() {
    ...
    setTimeout(() => {
      ...
      navigation.navigate('Question2', placar)
    }, 1000);
         ...
         <ImageBackground source={require('../../assets/pagina.png')} style={styles.backgroundImage} > 
          ...
          <View style={styles.container}>
            ...
            <TouchableOpacity activeOpacity={0.6} onPress={vencedor}>
              <Text style={btn}> Framework para desenvolvimento de projetos ágeis.</Text>
            </TouchableOpacity>

            <TouchableOpacity activeOpacity={0.6} onPress={perde1}>
              <Text style={bp1}> Cartão para sinalizar andamento do projeto. </Text>
            </TouchableOpacity>

            <TouchableOpacity activeOpacity={0.6} onPress={perde2}>
              <Text style={bp2}> É o responsável por garantir que o Scrum seja aplicado. </Text>
            </TouchableOpacity>
            <Text>
