...
function Question7({ navigation }) {
  ...
  function proxima() {
    ...
    setTimeout(() => {
      ...
      navigation.navigate('Question8', placar)
    }, 1000);
       ...
       <ScrollView> 
        <ImageBackground source={require('../../assets/pagina.png')} style={styles.backgroundImage} > 
          <View style={styles.container}>
            ...
            <Text style={styles.titulo}>O_____segue a teoria de transparência, inspeção e adaptação.
             </Text>

            <TouchableOpacity activeOpacity={0.6} onPress={perde1}>
              <Text style={bp1}> Sprint </Text>
            </TouchableOpacity>
            <TouchableOpacity activeOpacity={0.6} onPress={vencedor}>
              <Text style={btn}> Scrum </Text>
            </TouchableOpacity>
